...
foreach ($htmlQuestions as $difficulty => $questions) {
  foreach ($questions as $q) {
    ...
    try {
      ...
      die("ERROR inserting HTML question: " . $e->getMessage());
    }
  }
}

echo "✅ Inserted 150 HTML questions<br>";
...
foreach ($cssQuestions as $difficulty => $questions) {
  foreach ($questions as $q) {
    ...
    try {
      ...
      die("ERROR inserting CSS question: " . $e->getMessage());
    }
  }
}
...
echo "✅ Successfully seeded questions!<br>";
echo "Total in database: <strong>" . $check['count'] . "</strong><br>";
